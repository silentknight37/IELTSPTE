...
namespace IELTS_PTE_API.Controllers.Listening
{
    ...
    [ApiController]
    public class FillInBlanksController : ControllerBase
    {
        private FillInBlanksManager _fillInBlanksManager = new FillInBlanksManager();
        ...
        public JsonReturn Get()
        {
            ...
            Questions questions = _fillInBlanksManager.GetQuestions();
        ...
        {
            var response = new JsonReturn();
            QuestionSetup questions = _fillInBlanksManager.GetQuestionsById(id);
            response.Records = questions;
            return response;
        }
        ...
        {
            var response = new JsonReturn();
            response = _fillInBlanksManager.SaveQuestion(value);
            return response;
        }
    }
}
