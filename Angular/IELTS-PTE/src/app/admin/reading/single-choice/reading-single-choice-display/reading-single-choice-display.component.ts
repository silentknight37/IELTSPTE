...
@Component({
  selector: 'app-reading-single-choice-display',
  templateUrl: './reading-single-choice-display.component.html',
  styleUrls: ['./reading-single-choice-display.component.scss']
})
export class ReadingSingleChoiceDisplayComponent implements OnInit {
  ...
  ngOnInit() {
    this.spinner.show();
    this.readingWritingFillInTheBlanksService.getByAction('api/ReadingSingleChoice').subscribe(res=>{
