...
@Component({
  selector: 'app-highlight-correct-summary-display',
  templateUrl: './highlight-correct-summary-display.component.html',
  styleUrls: ['./highlight-correct-summary-display.component.scss']
})
export class HighlightCorrectSummaryDisplayComponent implements OnInit {
  ...
  correctAnswerDisplay:string;
    ...
    ngOnInit() {
      this.spinner.show();
      this.commonService.getByAction('api/HighlightCorrectSummary').subscribe(res=>{
