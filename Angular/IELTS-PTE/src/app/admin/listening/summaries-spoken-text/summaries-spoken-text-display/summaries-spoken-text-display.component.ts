...
import { Questions, QuestionSetup, ReadingWritingFillInTheBlanks, Answers, Question, ReviewEmail } from 'src/app/shared/common-question';
...
@Component({
  selector: 'app-summaries-spoken-text-display',
  templateUrl: './summaries-spoken-text-display.component.html',
  styleUrls: ['./summaries-spoken-text-display.component.scss']
})
export class SummariesSpokenTextDisplayComponent implements OnInit {
  ...
  reviewEmail=new ReviewEmail();
    ...
    ngOnInit() {
      this.spinner.show();
      this.commonService.getByAction('api/SummariesSpokenText').subscribe(res=>{
