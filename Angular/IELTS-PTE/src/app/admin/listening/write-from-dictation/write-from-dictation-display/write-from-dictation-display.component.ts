...
import { Question, Answers, Questions, QuestionSetup, ReadingWritingFillInTheBlanks } from 'src/app/shared/common-question';
...
@Component({
  selector: 'app-write-from-dictation-display',
  templateUrl: './write-from-dictation-display.component.html',
  styleUrls: ['./write-from-dictation-display.component.scss']
})
export class WriteFromDictationDisplayComponent implements OnInit {
  ...
  correctAnswerDisplay:string;
    ...
    ngOnInit() {
      this.spinner.show();
      this.commonService.getByAction('api/WriteFromDictation').subscribe(res=>{
