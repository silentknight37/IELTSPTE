...
import { Questions, QuestionSetup, Question, Answers } from 'src/app/shared/common-question';
// import { forkJoin } from 'rxjs';

@Component({
  selector: 'app-repeat-sentence-display',
  templateUrl: './repeat-sentence-display.component.html',
  styleUrls: ['./repeat-sentence-display.component.scss']
})
export class RepeatSentenceDisplayComponent implements OnInit {
  answerColor:string;
  ...
  ngOnInit() {
    this.spinner.show();
    this.commonService.getByAction('api/RepeatSentence').subscribe(res=>{
