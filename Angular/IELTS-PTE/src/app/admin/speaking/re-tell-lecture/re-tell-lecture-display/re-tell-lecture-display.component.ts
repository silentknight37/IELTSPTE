...
import { Questions, QuestionSetup, Answers, Question } from 'src/app/shared/common-question';
...
@Component({
  selector: 'app-re-tell-lecture-display',
  templateUrl: './re-tell-lecture-display.component.html',
  styleUrls: ['./re-tell-lecture-display.component.scss']
})
export class ReTellLectureDisplayComponent implements OnInit {
  ...
  ngOnInit() {
    this.spinner.show();
    this.commonService.getByAction('api/ReTellLecture').subscribe(res=>{
...
formData.append(fileName,blob);
      ...
      // }
  this.commonService.createwithFileAction(formData,'api/ReTellLecture/SendAnswer').subscribe(res=>{
    this.response = res;
