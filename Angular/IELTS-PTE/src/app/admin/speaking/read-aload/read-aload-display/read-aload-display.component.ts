...
import { Answers, Question, Questions, QuestionSetup } from 'src/app/shared/common-question';
import * as RecordRTC from 'recordrtc';

@Component({
  selector: 'app-read-aload-display',
  templateUrl: './read-aload-display.component.html',
  styleUrls: ['./read-aload-display.component.scss']
})
export class ReadAloadDisplayComponent implements OnInit {
  ...
  ngOnInit() {
    this.spinner.show();
    this.commonService.getByAction('api/ReadAloud').subscribe(res=>{
